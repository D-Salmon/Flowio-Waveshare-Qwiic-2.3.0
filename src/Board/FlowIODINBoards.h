...
inline constexpr UartSpec kFlowIOS3Uarts[] = {
    // Waveshare ESP32-S3: Nextion local on UART2.
    {"log", 0, -1, -1, 115200, true, -1},
    {"hmi", 2, 44, 43, 115200, false, -1}, // RX=GPIO44, TX=GPIO43.
};
...
inline constexpr I2cBusSpec kFlowIOS3I2c[] = {
    // Waveshare ESP32-S3 Qwiic/main IO bus. Interlink modules are excluded in standalone builds.
...
inline constexpr OneWireBusSpec kFlowIOS3OneWire[] = {
    // {name, signal, pin}
    {"temp_probe_1", BoardSignal::TempProbe1, 47}, // Temporary direct DS18B20 water bus.
    {"temp_probe_2", BoardSignal::TempProbe2, 48}, // Temporary direct DS18B20 air bus.
};
