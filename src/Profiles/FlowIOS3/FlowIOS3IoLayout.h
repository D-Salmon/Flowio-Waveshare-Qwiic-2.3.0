...
inline constexpr AnalogRoleDefault kAnalogRoleDefaults[] = {
    ...
    {DomainRole::OrpSensor, PortAdsExternal0, Calib::Orp::ExternalV3C0, Calib::Orp::ExternalV3C1, FLOW_WIRDEF_IO_A0P}, // ORP sur carte pH/ORP V3 ADS1115 diff 0.
    {DomainRole::PhSensor, PortAdsExternal1, Calib::Ph::ExternalV3C0, Calib::Ph::ExternalV3C1, FLOW_WIRDEF_IO_A1P}, // pH sur carte pH/ORP V3 ADS1115 diff 1.
