...
private:
    ...
    static constexpr uint8_t kWebAuthThrottleSlots = 32U;
    static constexpr uint8_t kWebAuthMaxFailures = 5U;
    static constexpr uint32_t kWebAuthWindowMs = 60000U;
    static constexpr uint32_t kWebAuthBlockMs = 300000U;
    static constexpr uint8_t kWebAuthGlobalMaxFailures = 40U;
    static constexpr uint32_t kWebAuthGlobalBlockMs = 60000U;
    ...
    uint32_t webAuthGlobalWindowStartMs_ = 0U;
    uint32_t webAuthGlobalBlockedUntilMs_ = 0U;
    uint8_t webAuthGlobalFailures_ = 0U;
