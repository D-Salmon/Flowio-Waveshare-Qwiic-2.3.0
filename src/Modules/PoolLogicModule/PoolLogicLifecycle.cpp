...
void PoolLogicModule::init(ConfigStore& cfg, ServiceRegistry& services)
{
    ...
    tankLevelMonitoringEnabledVar_.moduleName = kCfgModuleSensors;
    filtrationFeedbackIdVar_.moduleName = kCfgModuleSensors;
    chlorineGeneratorFeedbackIdVar_.moduleName = kCfgModuleSensors;
    filtrationFeedbackMonitoringEnabledVar_.moduleName = kCfgModuleSensors;
    chlorineGeneratorFeedbackMonitoringEnabledVar_.moduleName = kCfgModuleSensors;
    ...
    cfg.registerVar(tankLevelMonitoringEnabledVar_, kCfgModuleId, kCfgBranchSensors);
    cfg.registerVar(filtrationFeedbackIdVar_, kCfgModuleId, kCfgBranchSensors);
    cfg.registerVar(chlorineGeneratorFeedbackIdVar_, kCfgModuleId, kCfgBranchSensors);
    cfg.registerVar(filtrationFeedbackMonitoringEnabledVar_, kCfgModuleId, kCfgBranchSensors);
    cfg.registerVar(chlorineGeneratorFeedbackMonitoringEnabledVar_, kCfgModuleId, kCfgBranchSensors);
    ...
    if (alarmSvc_ && alarmSvc_->registerAlarm) {
        ...
        if (!alarmSvc_->registerAlarm(alarmSvc_->ctx, &filtrationContactorMismatchAlarm, &PoolLogicModule::condFiltrationContactorMismatchStatic_, this)) {
            LOGW("PoolLogic failed to register AlarmId::PoolFiltrationContactorMismatch");
        }

        const AlarmRegistration chlorineGeneratorContactorMismatchAlarm{
        ...
        if (!alarmSvc_->registerAlarm(alarmSvc_->ctx, &chlorineGeneratorContactorMismatchAlarm, &PoolLogicModule::condChlorineGeneratorContactorMismatchStatic_, this)) {
