...
Le profil `Micronova` est un firmware Flow.io dedie au pilotage d'une chaudiere a granules equipee d'une carte Micronova. Il est isole des profils piscine `FlowIO` et `Supervisor`.
